...
public class AppVehiculo {
    ...
    public static void main(String args[]) {
        ...
        VehiculoAnfibio vehiculoAnfibio1 = new VehiculoAnfibio("VA1", new PropulsionTerrestre(4));
        VehiculoAnfibio vehiculoAnfibio2 = new VehiculoAnfibio("VA2", new PropulsionAcuatica(2));
        ...
        vehiculoAnfibio1.convertirA(new PropulsionAcuatica(2));
        System.out.println("Vehículo Anfibio 1 CONVERTIDO - Matrícula: " + vehiculoAnfibio1.getMatricula() +
                ", Medio: " + vehiculoAnfibio1.getMedio() + ", Velocidad: " + vehiculoAnfibio1.getVelocidad());

        vehiculoAnfibio2.convertirA(new PropulsionTerrestre(4));
